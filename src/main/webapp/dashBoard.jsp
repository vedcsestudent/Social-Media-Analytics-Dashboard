...
<body>
    ...
    <div class="statistic-content-container">
        ...
        <div class="statistic-content-box">
          <%  if(session.getAttribute("avgSentimentScore")==null)
           ...
           <div class="value"><%=session.getAttribute("avgSentimentScore") %></div>
            <%} %> Sentiment Score
  ...
  <% if(filterListSize==0&&postListSize==0){ %>
  <div >No data found</div>
  <%}  else if(filterListSize!=0) {%>
  ...
  function color()
  {
	  const sentimentBox= document.getElementsByClassName("statistic-content-box")[2];
	  const value= document.getElementsByClassName("value")[0];
	  console.log(value.innerHTML);
	  console.log(sentimentBox);
	    if(value.innerHTML<=50)
	    	{
	    sentimentBox.style.backgroundColor="red";
	    sentimentBox.style.color="white";
	    	}
	    else
	    	{
	    	sentimentBox.style.backgroundColor="green";
		    sentimentBox.style.color="white";
